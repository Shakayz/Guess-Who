          ...
          <div className="bg-neutral-900/60 border border-neutral-800 rounded-2xl p-4 space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-1 ml-1">
                ...
                <div className="flex items-center gap-2 text-xs">
                  <span>⚖️</span>
                  <span className="text-indigo-400 font-semibold">{t('offline.mayor', 'Mayor')}</span>
                  <span className="text-neutral-500">— {t('offline.htpMayorDesc', 'Villager whose vote counts double once per game.')}</span>
                </div>
                <div className="flex items-center gap-2 text-xs">
                  <span>🥷</span>
                  <span className="text-fuchsia-400 font-semibold">{t('offline.infiltrator', 'Infiltrator')}</span>
                ...
                <div className="flex items-center gap-2 text-xs">
                  <span>🃏</span>
                  <span className="text-pink-400 font-semibold">{t('offline.jester', 'Jester')}</span>
                  <span className="text-neutral-500">— {t('offline.htpJesterDesc', 'Solo role. Wins alone if voted out by the group.')}</span>
                </div>
                <div className="flex items-center gap-2 text-xs">
                  <span>👨‍⚖️</span>
                  <span className="text-emerald-300 font-semibold">{t('offline.judge', 'Judge')}</span>
                ...
                <div className="flex items-center gap-2 text-xs">
                  <span>👻</span>
                  <span className="text-teal-300 font-semibold">{t('offline.revenant', 'Revenant')}</span>
                ...
                <div className="flex items-center gap-2 text-xs">
                  <span>💥</span>
                  <span className="text-red-300 font-semibold">{t('offline.kamikaze', 'Kamikaze')}</span>
                ...
                <div className="flex items-center gap-2 text-xs">
                  <span>🕷️</span>
                  <span className="text-orange-300 font-semibold">{t('offline.corruptor', 'Corruptor')}</span>
                ...
                <div className="flex items-center gap-2 text-xs">
                  <span>🔄</span>
                  <span className="text-rose-300 font-semibold">{t('offline.inverter', 'Inverter')}</span>
                ...
                <div className="flex items-center gap-2 text-xs">
                  <span>👯</span>
                  <span className="text-purple-300 font-semibold">{t('offline.evilTwins', 'Evil Twins')}</span>
