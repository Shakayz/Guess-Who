...
const mockGameState = {
  ...
  guardianProtectUsed: null as unknown,
  guardianProtectedPlayer: null as unknown,
  mayorDoubleVoteUsed: false,
  mayorDoubleActive: false,
  inverterUsed: false,
  inverterActive: false,
  corruptorTargetUserId: null as unknown,
  twinPartner: null as unknown,
  revenantVotesRemaining: 0,
  revealedPlayer: null as unknown,
  messages: [] as unknown[],
  ...
  setGuardianProtectUsed: vi.fn(),
  setGuardianProtectedPlayer: vi.fn(),
  setMayorDoubleActive: vi.fn(),
  resetMayorDoubleActive: vi.fn(),
  setInverterActive: vi.fn(),
  resetInverterActive: vi.fn(),
  setCorruptorTarget: vi.fn(),
  setTwinPartner: vi.fn(),
  setRevenantVotesRemaining: vi.fn(),
