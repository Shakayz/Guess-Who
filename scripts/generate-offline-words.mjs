#!/usr/bin/env node
/**
 * Generates packages/shared/src/offlineWords.ts from rich, diverse 40-item pools.
 *
 ...
 *
 * Output: 10 locales x 12 categories x 780 pairs = 93,600 pairs total.
 */
 ...
 *
 * Generated by scripts/generate-offline-words.mjs from rich, diverse 40-item
 * pools per (locale, category). Each pool mixes sub-types so any pair shares
 * the category umbrella. Emits all C(40,2) = 780 pairs.
 *
 * 10 locales x 12 categories x 780 pairs = 93,600 pairs total.
 */
